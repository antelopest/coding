...
a space to be added at the end of that same word and have it returned as an array?
...
const tests = [
    ["apple ban", ["apple 5", "ban 3"]],
    ["you will win", ["you 3", "will 3", "win 3"]]
];

const startTest = (addLength, tests) => {
    tests.forEach(e => {
        console.log(addLength(e[0]), e[1]);
    });
}

startTest(addLength, tests);